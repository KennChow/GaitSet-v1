...
class Model:
    ...
    def transform(self, flag, batch_size=1):
        ...
        # print("feature.size():")
        # print(len(feature_list))  # 5485  其实应该是5500个视频 数据中所有视频的数量为5500 这里忽略了5号
    ...
    def transform_gallery(self, flag, batch_size=1):
        self.encoder.eval()
        source = self.gallery_source if flag == 'gallery' else self.probe_source
        # source = self.gallery_source
        self.sample_type = 'all'
        data_loader = tordata.DataLoader(
            dataset=source,
